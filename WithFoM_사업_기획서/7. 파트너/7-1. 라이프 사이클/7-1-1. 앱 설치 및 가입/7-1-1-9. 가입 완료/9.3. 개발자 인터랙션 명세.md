...
**9.3.1.1.** API 호출 - 가입 완료 확인
　1: 엔드포인트: POST /api/v1/partner/signup/complete
　2: 요청 바디
...
**9.3.2.1.** API 호출 - 가입 요약 조회
　1: 엔드포인트: GET /api/v1/partner/{partnerId}/signup-summary
　2: 응답 데이터
