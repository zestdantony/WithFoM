...
**4.5.1.2.** API 호출 - 아이디 중복 확인  
　1: 엔드포인트: GET /api/v1/auth/check-username  
　2: 요청 파라미터  
...
**4.5.3.1.** API 호출 - 계정 생성  
　1: 엔드포인트: POST /api/v1/auth/register  
　2: 요청 바디  
