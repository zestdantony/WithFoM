...
**6.5.1.1.** API 호출 - 사업자 진위 확인
　1: 엔드포인트: POST /api/v1/business/verify
　2: 요청 바디
...
**6.5.4.2.** API 호출 - 수동 인증 요청
　1: 엔드포인트: POST /api/v1/business/manual-verify
　2: 요청 (multipart/form-data)
...
**6.5.5.1.** API 호출 - 인증 상태 조회
　1: 엔드포인트: GET /api/v1/business/manual-verify/{requestId}/status
　2: 응답 데이터
