...
**5.12.5.2.** API 호출 - 예금주 확인  
　1: 엔드포인트: POST /api/v1/bank/verify-account  
　2: 요청 바디  
...
**5.12.6.1.** API 호출 - 매장 기본 정보 저장  
　1: 엔드포인트: POST /api/v1/partner/store/basic-info  
　2: 요청 바디  
