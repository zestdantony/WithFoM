...
　J. `features.monthlyBonusCoins`: 폼 코인 월 증정 수량 (베이직: 0, 플러스: 200, 프리미엄: 500). 게임 운영용 코인으로, 코인 관리(7-2-7-2 > 2.1.) 현황에 반영  
　K. `features.gameTypeChangeLimit`: 게임 유형 월 변경 횟수 한도 (베이직: 1, 플러스: 2, 프리미엄: -1=무제한). 게임 설정(7-2-7-1 > 1.1.) 유형 변경 버튼 활성화 기준  
　L. `features.rewardStorageMax`: 리워드 저장 라이브러리 최대 수량 (베이직: 6, 플러스: 12, 프리미엄: 24). 리워드 설정(7-2-8-3 > 3.1.7.) 저장 한도 적용  
　M. `features.gamePresetMax`: 게임 프리셋 저장 최대 수량 (베이직: 1, 플러스: 2, 프리미엄: 4). 파트너 게임·광고주 게임 프리셋 각각 독립 적용(7-2-7-1 > 1.3., 1.4.)  
  ...
  "plans": [
    {
      ...
      "benefits": [
        ...
        "고객 리스트 관리",
        "빠른 발주·재고 관리",
        "게임 유형 월 1회 변경, 리워드 6개·프리셋 1개 저장"
      ],
      "stampLevel": "BASIC"
    },
    {
      ...
      "benefits": [
        ...
        "휴면 고객 케어 (알림톡 월 30회)",
        "고객 관리 랭킹·벤치마크",
        "폼 코인 월 200개 증정(게임 운영용)",
        "게임 유형 월 2회 변경, 리워드 12개·프리셋 2개 저장"
      ],
      "stampLevel": "EXTENDED"
    },
    {
      ...
      "benefits": [
        ...
        "세분화 벤치마크·인사이트",
        "랭킹·퍼센타일·우선 지원",
        "폼 코인 월 500개 증정(게임 운영용)",
        "게임 유형 무제한 변경, 리워드 24개·프리셋 4개 저장"
      ],
      "stampLevel": "PREMIUM"
    }
  ]
